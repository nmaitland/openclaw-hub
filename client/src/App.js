  ...
  return (
    <div className="app">
      ...
      <main className="main unified">
        ...
        <section className="overview-section">
          <div className="status-card main-status">
            ...
            <div className="last-active">
              Updated: {status?.swissclaw?.lastActive ? new Date(status.swissclaw.lastActive).toLocaleTimeString() : 'Ã¢â‚¬â€'}
            </div>
          </div>
        ...
        <div className="content-grid">
          ...
          <section className="kanban-summary">
            <h2>Ã°Å¸Â¦â‚¬ My Kanban</h2>
            
            {kanban?.inProgress?.length > 0 && (
              <div className="kanban-section">
                <h3>Ã°Å¸Å¡â‚¬ In Progress</h3>
          ...
          <section className="tasks-section">
            <h2>Ã°Å¸â€˜Â¤ Your Action Items</h2>
        ...
        {status?.recentActivities && status.recentActivities.length > 0 && (
          <section className="activity-section">
            <h2>Ã°Å¸â€œÅ  Recent Activity</h2>
              ...
              <div className="messages">
                {messages.length === 0 ? (
                  ...
                  [...messages].reverse().map((msg) => (
                    <div key={msg.id} className={`message ${msg.sender === 'operator' ? 'message-operator' : 'message-swissclaw'}`}>
      ...
      <footer className="footer">
        <p>
          Swissclaw Hub v{buildInfo.version} Ã¢â‚¬â€ Built with Ã°Å¸Â¦â‚¬ Ã¢â‚¬â€{' '}
