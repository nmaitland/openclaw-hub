...
const COLUMNS = [
  { name: 'backlog', displayName: 'Backlog', emoji: 'Ã°Å¸â€œÂ' },
  { name: 'todo', displayName: 'To Do', emoji: 'Ã°Å¸â€œâ€¹' },
  { name: 'inProgress', displayName: 'In Progress', emoji: 'Ã°Å¸Å¡â‚¬' },
  { name: 'review', displayName: 'Review', emoji: 'Ã°Å¸â€˜â‚¬' },
  { name: 'done', displayName: 'Done', emoji: 'Ã¢Å“â€¦' },
  { name: 'waiting', displayName: 'Waiting', emoji: 'Ã¢ÂÂ¸Ã¯Â¸Â', special: true }
];
...
function KanbanBoard() {
  ...
  return (
    <div className="kanban-board">
      <h2 className="kanban-title">Ã°Å¸Â¦â‚¬ Swissclaw Kanban</h2>
        ...
        <div className="modal-overlay" onClick={closeTaskModal}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              ...
              <button className="modal-close" onClick={closeTaskModal}>Ãƒâ€”</button>
            </div>
        ...
        <div className="modal-overlay" onClick={closeAddModal}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              ...
              <button className="modal-close" onClick={closeAddModal}>Ãƒâ€”</button>
            </div>
