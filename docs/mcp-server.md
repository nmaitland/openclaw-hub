...
The MCP server is a thin adapter layer Ã¢â‚¬â€ it translates MCP tool calls into HTTP requests to the Hub's existing REST API. It doesn't access the database directly.
